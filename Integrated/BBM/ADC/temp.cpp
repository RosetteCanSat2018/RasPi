...
#define I_GAIN_2 0.01
#define D_GAIN_2 10000//1000//160
...
void func() {
	...
	if (!mode) {
		...
		if (-FULL_DEGREE_CONDITION < error && error < FULL_DEGREE_CONDITION && !(-ADVANCED_DEGREE_CONDITION < error && error < ADVANCED_DEGREE_CONDITION)) {
			pid2.IerrorReset();
		}
